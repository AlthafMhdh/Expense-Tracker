      ...
      <div className="my-5 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* <InfoCard
            ...
            color="bg-primary"
            //color={dashboardData?.totalBalance < 0 ? "bg-red-600" : "bg-orange-500"}
          /> */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          ...
          <RecentIncomeWithChart
            data = {dashboardData?.last60DaysIncomes?.transaction?.slice(0,4) ||[]}
            totalIncome = {dashboardData?.totalIncome || 0}
          />

          <RecentIncome
            transaction = {dashboardData?.last60DaysIncomes?.transaction ||[]}
